...
class Venta(models.Model):
    ...
    tVenta = models.IntegerField( null=True, blank=True, verbose_name="total venta")
    idCliente= models.ForeignKey(Cliente, on_delete=models.CASCADE)
...
class Producto(models.Model):
    ...
    precio = models.IntegerField( null=True, blank=True, verbose_name="precio producto")
    cantidad = models.IntegerField( null=True, blank=True, verbose_name="cantidad producto")
